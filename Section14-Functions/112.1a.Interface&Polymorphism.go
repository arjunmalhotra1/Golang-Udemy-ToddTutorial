...
func bar(h human){
	...
	// we know that becasuee we call h.(peron) and h.(secretAgent) inside switch.
	// Now we can call "h.(person).fname" and "h.(secretAgent).fname"
	// "h.(person).fname" says I know this "h" is type person as we jsut asserted it
